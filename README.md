...
{Used VS Code as IDE, typescript, nestjs framwork, github, git}

{Nest Js a typescript javascript backend framework used for building scalable backend services}
